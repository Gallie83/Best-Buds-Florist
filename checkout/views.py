...
def cache_checkout_data(request):
    try:
        ...
        messages.error(
            request, 'Sorry, there was an error processing your payment.\ please try again.')
        return HttpResponse(content=e, status=400)


def checkout(request):
    """ Returns checkout template and checks if checkout form is valid """
            ...
            for item_id, quantity in bag.items():
                ...
                # If product is not found, return error
                    ...
                    messages.error(request, (
                        "A product in your cart wasn't found in our database. "
...
def checkout_success(request, order_number):
    """ Returns checkout success template if checkout form is valid """

    # Save order info and return success message
